<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Import RI MonthlyContributionReportCurrent.ascx.cs" Inherits="DesktopModules_AIS_Admin_Import_RI" %>
...
<asp:Panel runat="server" ID="panel">
    <div>
        <h2>Importation du fichier extrait du site Rotary.org (MonthlyContributionReportCurrent.xlsx)</h2>
