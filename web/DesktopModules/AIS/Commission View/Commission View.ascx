...
<asp:Panel ID="pnl_admin" runat="server" CssClass="panel-body">
...
<asp:Panel ID="pnl_edit" runat="server" Visible="false" CssClass="panel-body">
    <asp:Panel ID="Panel1" runat="server">
        <p>Sélectionnez une commission à modifier : <asp:DropDownList ID="ddl_commission" runat="server"></asp:DropDownList> &nbsp <asp:Button ID="btn_commission" CssClass="btn btn-xs btn-primary" runat="server" Text="Valider" OnClick="btn_commission_Click" /></p>
        <br />
