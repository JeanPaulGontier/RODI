...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OfficeClub.ascx.cs" Inherits="DesktopModules_AIS_Office_Club_OfficeClub" %>
    ...
    <div class="row text-center">
       ...
       <asp:DataList ID="dataList_Members" runat="server" OnItemDataBound="dataList_Members_ItemDataBound" Width="100%" RepeatLayout="Flow" CssClass="MiniTrombi" ItemStyle-CssClass="col-md-4">
            <ItemTemplate>
