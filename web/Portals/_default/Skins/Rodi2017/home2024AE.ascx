  ...
  <div class="skin_main">
    ...
    <section  class="content_whitebg">
        <div>
          <div class="skin_width">
              <div class="row dnnpane pcr_mx_0 pcr_my_3">
                  <div runat="server" id="SixGrid6A1" class="six_grid6a col-sm-6"></div>
                  <div runat="server" id="SixGrid6B1" class="six_grid6b col-sm-6"></div>
                </div>
          </div>
        </div>
    </section>
    ...
    <section  class="content_graybg">
        <div>
          <div class="skin_width">
              <div class="row dnnpane pcr_mx_0 pcr_my_3">
                  <div runat="server" id="SixGrid6A2" class="six_grid6a col-sm-6"></div>
                  <div runat="server" id="SixGrid6B2" class="six_grid6b col-sm-6"></div>
                </div>
              </div>
             </div>
       </section>
    ...
    <section class="content_whitebg">
        <div>
          <div class="skin_width">
              <div class="row dnnpane pcr_mx_0 pcr_my_3">
                  <div runat="server" id="SixGrid6A3" class="six_grid6a col-sm-6"></div>
                  <div runat="server" id="SixGrid6B3" class="six_grid6b col-sm-6"></div>
                </div>
          </div>
          <div class="skin_width">
              <div class="row dnnpane pcr_mx_0 pcr_my_3">
